...
_penalty_noise = RewardTermCfg(
    ...
    weight=-600.0,
    params={"noise_predictor_ckpt": "", "gate_window": 5},  # noise_predictor_ckpt required, override on CLI
    tags=["penalty_curriculum"],
)

g1_23dof_loco_quiet = replace(
    g1_23dof_loco,
    terms={**g1_23dof_loco.terms, "penalty_noise": _penalty_noise},
)

g1_23dof_loco_quiet_fast_sac = replace(
